...
export default function MarketPositionCard({ score }) {
  return (
    <section className="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-[0_12px_30px_rgba(15,23,42,0.04)]">
      ...
      <div className="mt-4 flex flex-wrap items-end gap-5">
        ...
        <p className="max-w-52 pb-2 text-sm leading-6 text-slate-500">Better than {score}% of Data Analysts in Malaysia</p>
      </div>
